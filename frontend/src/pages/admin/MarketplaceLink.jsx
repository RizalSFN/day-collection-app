                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <h2 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                            ...
                            <LinkIcon className="text-amber-500" size={28} />
                        </h2>
                        <p className="text-gray-500 text-sm mt-1">Kelola tautan produk ke berbagai marketplace.</p>
                    </div>
                    <button
                        onClick={() => setOpenCreateModal(true)}
                        className="flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-2xl font-bold transition shadow-lg shadow-amber-200 active:scale-95"
                    >
                        <Plus size={20} />
                        Tambah Link
                    </button>
