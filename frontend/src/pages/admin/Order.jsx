                                ...
                                <div>
                                        ...
                                        {selectedOrder.items.map((item, idx) => (
                                            <div key={idx} className="flex gap-4 p-3 rounded-xl border border-gray-100 hover:border-gray-200 transition-colors">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-sm font-bold text-amber-600">Rp {item.product_variants.price.toLocaleString('id-ID')}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="mt-6 pt-4 border-t-2 border-dashed border-gray-100 space-y-2">
                                        ...
                                        <div className="flex justify-between text-xs font-medium text-gray-500">
                                            ...
                                            <span>
                                                Rp {selectedOrder.items.reduce((acc, item) => acc + (item.product_variants.price * item.quantity), 0).toLocaleString('id-ID')}
                                            </span>
                                        </div>
